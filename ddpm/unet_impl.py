...
from unet_parts import Upsample, DownSample, ConvNextBlock, SinusoidalPosEmb, BlockAttention
...
if __name__ == "__main__":
    ...
    models = [
        OneResUNet(64, channels=3).to("cuda"),
        TwoResUNet(64, channels=3).to("cuda"),
        AttentionUNet(64, channels=3).to("cuda")
    ]
